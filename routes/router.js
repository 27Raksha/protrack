...
router.post('/createWeeklyRating',workReport.createWeeklyRatings);

router.post('/createWeeklyTaskReport',workReport.createWeeklyReport);
...
router.post('/fetchDescription', workReport.fetchConcatenatedDescription);
...
router.post('/CreateWeeklyPlan',workReport.createWeeklyPlanReport);
